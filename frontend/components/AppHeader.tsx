...
const styles = StyleSheet.create({
  ...
  headerIconImg: { width: 32, height: 32, borderRadius: 6 },
  brandText: { fontSize: 18, fontWeight: '800', color: '#0A0A0A', letterSpacing: 0.2 },
  ...
  drawerIconImg: { width: 44, height: 44, borderRadius: 8 },
  drawerBrandText: { fontSize: 22, fontWeight: '800', color: '#0A0A0A', letterSpacing: 0.3 },
