...
.btn-call{{background:#0891B2;color:#FFFFFF;}}
.brand-foot{{text-align:center;color:#94A3B8;font-size:11px;margin-top:14px;}}
</style></head>
<body>
<div class="wrap">
  ...
  <div class="card">
    <div class="btns">
      ...
      <a href="{refuse_action_url}" class="btn btn-danger" onclick="return confirm('Êtes-vous certain·e de vouloir refuser ce rendez-vous? Le rendez-vous sera annulé.');"><span style="color:#000;">✕</span> Refuser</a>
    </div>
  </div>
